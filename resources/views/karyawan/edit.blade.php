...
>>>>>>> ad3d3fee50c466ca4e60187deaa77e9b4201f37e
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="karyawan">
                                        <form action="{{ route('karyawan.update', ['id' => $karyawan->id]) }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <select class="form-control select2bs4" id="jabatans"
                                                        name="jabatan_id" style="width: 100%;">
                                            ...
                                            <div class="form-group row">
                                                <label for="tgl_kontrak1" class="col-sm-3 col-form-label">Tanggal Masuk
                                                    Dinas 1</label>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="form-group row">
                                                <label for="akhir_kontrak1" class="col-sm-3 col-form-label">Tanggal
                                                    Berakhir Kontrak ke 1</label>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="form-group row">
                                                <label for="tgl_kontrak2" class="col-sm-3 col-form-label">Tanggal Masuk
                                                    Dinas 2</label>
                                                <div class="col-sm-3">
                                                    <input type="date" class="form-control" id="tgl_kontrak2"
                                                        name="tgl_kontrak2"
                                            ...
                                            <div class="form-group row">
                                                <label for="akhir_kontrak2" class="col-sm-3 col-form-label">Tanggal
                                                    Berakhir Kontrak ke 2</label>
                                                <div class="col-sm-3">
                                                    <input type="date" class="form-control" id="akhir_kontrak2"
                                                        name="akhir_kontrak2"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <select class="form-control" name="status" id="resignSelect">
                                                        <option value="active"
                                                            {{ $karyawan->status == 'active' ? 'selected' : '' }}>
                                                            Active
                                                        </option>
                                                        <option value="resign"
                                                            {{ $karyawan->status == 'resign' ? 'selected' : '' }}>
                                                            Resign
                                                        </option>
                                                    </select>
                                                    @error('units')
                                    ...
                                    <div class="tab-pane" id="pendidikan">
                                        <form action="{{ route('karyawan.update', ['id' => $karyawan->id]) }}"
                                            ...
                                            @method('PUT')
                                            <div class="form-group row">
                                                <label for="institusi" class="col-sm-3 col-form-label">Asal
                                                    Institusi</label>
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" id="institusi"
                                                        placeholder="Asal institusi" name="institusi"
                                                        value="{{ $karyawan->pendidikan->institusi ?? '' }}">
                                                    @error('institusi')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" id="nomer_ijazah"
                                                        placeholder="Nomer Ijazah" name="nomer_ijazah"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" id="nomer_str"
                                                        ...
                                                        value="{{ $karyawan->pendidikan->nomer_str }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="date" class="form-control" id="exp_str"
                                                        placeholder="Masa Aktif STR" name="exp_str"
                                                        value="{{ $karyawan->pendidikan->exp_str }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" id="profesi"
                                                        ...
                                                        value="{{ $karyawan->pendidikan->profesi }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" id="cert_profesi"
                                                        placeholder="Sertifikat Profesi" name="cert_profesi"
                                                        value="{{ $karyawan->pendidikan->cert_profesi }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="pelatihan" class="col-sm-3 col-form-label">Pelatihan</label>
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" id="pelatihan"
                                                        placeholder="Pelatihan Yang Di Ikuti" name="pelatihan"
                                                        value="{{ $karyawan->pendidikan->pelatihan }}">
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="kontak">
                                        <form action="{{ route('karyawan.update', ['id' => $karyawan->id]) }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="number" class="form-control" id="nomer_ktp"
                                                        placeholder="Nomer KTP" name="nomer_ktp"
                                                        value="{{ $karyawan->nomer_ktp }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-check" style="margin-left: 10px;">
                                                    <input class="form-check-input" type="radio" id="l"
                                                        name="gender" value="{{ $karyawan->gender }}" required>
                                                    <label class="form-check-label" for="l">L</label>
                                                    <input class="form-check-input" type="radio" id="p"
                                                        name="gender" value="{{ $karyawan->gender }}"
                                            ...
                                            <div class="form-group row">
                                                <label for="status_perkawinan" class="col-sm-3 col-form-label">Status
                                                    Perkawinan</label>
                                                <div class="form-check" style="margin-left: 10px;">
                                                    <input class="form-check-input" type="radio" id="menikah"
                                                        name="status_ktp" value="{{ $karyawan->status_ktp }}" required>
                                                    <label class="form-check-label" for="menikah">Menikah</label>
                                                    <input class="form-check-input" type="radio" id="belum_menikah"
                                                        name="status_ktp" value="{{ $karyawan->status_ktp }}"
                                                        style="margin-left: 6px;" required>
                                            ...
                                            <div class="form-group row">
                                                <label for="telepon" class="col-sm-3 col-form-label">Nomer
                                                    Telepon</label>
                                                <div class="col-sm-3">
                                                    <input type="number" class="form-control" id="telepon"
                                                        placeholder="Nomer Telepon" name="telepon"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" id="npwp"
                                                        placeholder="NPWP" name="npwp" value="{{ $karyawan->npwp }}">
                                                </div>
                                            </div>
