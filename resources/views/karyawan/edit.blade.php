                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="karyawan">
                                    <form action="{{ route('karyawan.update', ['id' => $karyawan->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label for="tgl_kontrak1" class="col-sm-2 col-form-label">Tanggal Masuk Dinas 1</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row">
                                            <label for="akhir_kontrak1" class="col-sm-2 col-form-label">Tanggal Berakhir Kontrak ke 1</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row">
                                            <label for="tgl_kontrak2" class="col-sm-2 col-form-label">Tanggal Masuk Dinas 2</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row">
                                            <label for="akhir_kontrak2" class="col-sm-2 col-form-label">Tanggal Berakhir Kontrak ke 2</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div id="resignForm" style="display: {{ $karyawan->status == 'resign' ? 'block' : 'none' }};">
                                            <div class="form-group row">
                                                <label for="resign" class="col-sm-2 col-form-label">Alasan
                                                    Resign:</label>
                                                <div class="col-sm-3">
                                            ...
                                            <div class="form-group row">
                                                <label for="tgl_resign" class="col-sm-2 col-form-label">Tanggal
                                                    resign:</label>
                                                <div class="col-sm-3">
                                ...
                                <div class="tab-pane" id="pendidikan">
                                    <form action="{{ route('karyawan.update', ['id' => $karyawan->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        @method('PUT')
                                        <div class="form-group row">
                                            <label for="institusi" class="col-sm-2 col-form-label">Asal Institusi</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row">
                                            <label for="tahun_lulus" class="col-sm-2 col-form-label">Tahun
                                                Lulus</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row">
                                            <label for="nomer_ijazah" class="col-sm-2 col-form-label">Nomer
                                                Ijazah</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row">
                                            <label for="nomer_str" class="col-sm-2 col-form-label">Nomer STR</label>
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" id="nomer_str" placeholder="Nomer STR" name="nomer_str" value="{{ $karyawan->pendidikan->nomer_str }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="exp_str" class="col-sm-2 col-form-label">Masa Aktif
                                                STR</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group row">
                                            <label for="cert_profesi" class="col-sm-2 col-form-label">Sertifikat
                                                Profesi</label>
                                            <div class="col-sm-3">
                                ...
                                <div class="tab-pane" id="kontak">
                                    <form action="{{ route('karyawan.update', ['id' => $karyawan->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        @method('PUT')
                                        <div class="form-group row">
                                            <label for="nomer_ktp" class="col-sm-2 col-form-label">Nomer KTP</label>
                                            <div class="col-sm-3">
                                                <input type="number" class="form-control" id="nomer_ktp" placeholder="Nomer KTP" name="nomer_ktp" value="{{ $karyawan->nomer_ktp }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="tempat_tgl_lahir" class="col-sm-2 col-form-label">Tempat Tanggal Lahir</label>
                                            <div class="col-sm-3">
                                                <input type="date" class="form-control" id="tempat_tgl_lahir" placeholder="Tempat Tanggal Lahir" name="tanggal_lahir" value="{{ $karyawan->tanggal_lahir }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" id="status_perkawinan" placeholder="Status Perkawinan" name="status_perkawinan" value="{{ $karyawan->status_perkawinan }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="telepon" class="col-sm-2 col-form-label">Nomer Telepon</label>
                                            <div class="col-sm-3">
