                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link active" href="#karyawan" data-toggle="tab">Karyawan</a>
                                </li>
                                    ...
                                    <div class="active tab-pane" id="karyawan">
                                        <form action="{{ route('karyawan.store') }}" method="POST" class="form-horizontal">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input type="text" class="form-control" id="nomer_ktp"
                                                        placeholder="No KTP" name="nomer_ktp">
                                                    @error('nomer_ktp')
                                                        <small>
                                                            <p class="text-danger">{{ $message }}</p>
                                                        </small>
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input type="text" class="form-control" id="telepon"
                                                        placeholder="No Telepon" name="telepon">
                                                    @error('telepon')
                                                        <small>
                                                            <p class="text-danger">{{ $message }}</p>
                                                        </small>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                                ...
                                                <select class="form-control select2bs4" id="jabatans" name="jabatan_id" style="width: 100%;" required>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <select class="form-control select2bs4" id="Unit" name="unit_id" style="width: 100%;" required>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <input type="date" class="form-control" id="tgl_kontrak1" name="tgl_kontrak1" value="{{ old('tgl_kontrak1') }}" required>
                                                @error('tgl_kontrak1')
                                                <small>
                                                    <p class="text-danger">{{ $message }}</p>
                                                </small>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <input type="date" class="form-control" id="akhir_kontrak1" name="akhir_kontrak1" value="{{ old('akhir_kontrak1') }}" required>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                ...
                                                <input type="text" class="form-control" id="alamat" placeholder="Alamat" name="alamat_ktp" required>
                                                @error('alamat_ktp')
                                                <small>
                                                    <p class="text-danger">{{ $message }}</p>
                                                </small>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <input type="text" class="form-control" id="inputTempatlahir" placeholder="Tempat Lahir" name="tempat_lahir" required>
                                                @error('tempat_lahir')
                                                <small>
                                                    <p class="text-danger">{{ $message }}</p>
                                                </small>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="l" name="gender" value="l" required>
                                                    <label class="form-check-label" for="l">L</label>
                                                    <input class="form-check-input" type="radio" id="p" name="gender" value="p" style="margin-left: 6px;" required>
                                            ...
                                            <div class="col-sm-3" style="margin-left: -55px;">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="menikah" name="status_ktp" value="menikah" required>
                                                    <label class="form-check-label" for="menikah">Menikah</label>
                                                    <input class="form-check-input" type="radio" id="belum_menikah" name="status_ktp" value="belum menikah" style="margin-left: 6px;" required>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                ...
                                                <input type="text" class="form-control" id="inputInstitusi" placeholder="institusi" name="institusi" required>
                                                @error('institusi')
                                                <small>{{ $message }}</small>
                                                @enderror
                                            </div>
                                            <div class="col-sm-2">
                                                ...
                                                <input type="text" class="form-control" id="inputPendidikan" placeholder="Pendidikan Terakhir" name="pendidikan_terakhir" required>
                                            </div>
                                            <div class="col-sm-2">
                                                <label for="tahun lulus" class="form-label">Tahun Lulus</label>
                                                <input type="number" class="form-control" id="TahunLulus" placeholder="Tahun Lulus" name="tahun_lulus" required>
                                            </div>
                                            <div class="col-sm-2">
                                                <label for="no ijazah" class="form-label">Nomer Ijazah</label>
                                                <input type="text" class="form-control" id="nomer_ijazah" placeholder="Nomer Ijazah" name="nomer_ijazah" required>
                                            </div>
                                            <div class="col-sm-2">
                                                <label for="no str" class="form-label">Nomer STR</label>
                                                <input type="text" class="form-control" id="nomer_str" placeholder="Nomer STR" name="nomer_str" required>
                                            </div>
                                            <div class="col-sm-2">
                                                <label for="expired str" class="form-label">Masa Berlaku STR</label>
                                                <input type="date" class="form-control" id="exp_str" name="exp_str" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-3">
                                                <label for="cert profesi" class="form-label">Sertifikat
                                                    Profesi</label>
                                                <input type="text" class="form-control" id="cert_profesi" name="cert_profesi" placeholder="Sertifikat Profesi" required>
                                            </div>
                                        </div>
