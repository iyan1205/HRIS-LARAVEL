                                    ...
                                    <div class="active tab-pane" id="karyawan">
                                        <form action="{{ route('karyawan.store') }}" method="POST" class="form-horizontal">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-2">
                                                    <label for="tgl_kontrak1" class="form-label">Tanggal Masuk Dinas
                                                        :</label>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-3">
                                                    ...
                                                    <input type="text" class="form-control" id="alamat"
                                                        placeholder="Alamat" name="alamat_ktp">
                                                    @error('alamat_ktp')
                                                        <small>
                                                            <p class="text-danger">{{ $message }}</p>
                                                        </small>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-3">
                                                    ...
                                                    <input type="text" class="form-control" id="inputInstitusi"
                                                        placeholder="institusi" name="institusi">
                                                    @error('institusi')
                                                        <small>{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input type="text" class="form-control" id="cert_profesi"
                                                        name="cert_profesi" placeholder="Sertifikat Profesi">
                                                </div>
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input" type="radio" id="belum_menikah"
                                                            name="status_ktp" value="belum_menikah" style="margin-left: 6px;">
