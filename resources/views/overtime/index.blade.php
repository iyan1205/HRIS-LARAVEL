                                    ...
                                    <tbody>
                                        @foreach ($overtimes as $overtime)
                                            <tr>
                                                ...
                                                <td>{{ $overtime->leavetype->name }}</td>
                                                <td>{{ \Carbon\Carbon::parse($overtime->start_date)->format('d/m/Y') }}
                                                </td>
                                                <td>{{ \Carbon\Carbon::parse($overtime->end_date)->format('d/m/Y') }}
                                                </td>
                                                <td>{{ $overtime->total_days }} Hari</td>
                                                <td><span class="tag tag-success">{{ $overtime->status }}</span></td>
