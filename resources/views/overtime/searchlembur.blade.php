    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Cari Data Lembur</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('approval-overtime') }}">Approval Lembur</a></li>
                            <li class="breadcrumb-item active">Cari Data Lembur</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body ">
                                <form action="{{ route('search.al') }}" method="GET">
                                        ...
                                        <div class="form-group">
                                            <label>Tanggal Awal (Lembur):</label>
