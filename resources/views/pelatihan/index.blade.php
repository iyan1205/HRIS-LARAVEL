                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-actions text-right">
                                            <a href="{{ route('pelatihan.edit', ['id' => $pelatihan->id]) }}" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"></i>
                                                Edit</a>
                                            <a data-toggle="modal" data-target="#modal-hapus{{ $pelatihan->id }}" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>
                                                Hapus</a>
                                        </td>
                                    </tr>
